...
public class InvList {
  ...
  public void print() {
	...
	public void sortInvertedList() {
		Collections.sort(this.postings, new docIdComparator());		
	}
	
	public class docIdComparator implements Comparator<DocPosting> {
		@Override
		public int compare(DocPosting o1, DocPosting o2) {
			String[] temps;
			try {
				return QryEval.READER.document(o1.docid).get("externalId").compareTo(QryEval.READER.document(o2.docid).get("externalId"));
			} catch (IOException e) {
