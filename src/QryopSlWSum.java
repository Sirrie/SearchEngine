	...
	/*
	  ...
	  private double computeDefaultScore(RetrievalModelIndri r, long docid) throws IOException {
			...
			for (int i = 0; i < this.args.size(); i ++) {
				...
				result += score * this.weights.get(i) / this.totalWeight;
			}
			return result;
		}
